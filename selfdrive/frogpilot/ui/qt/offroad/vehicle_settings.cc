...
FrogPilotVehiclesPanel::FrogPilotVehiclesPanel(FrogPilotSettingsWindow *parent) : FrogPilotListWidget(parent), parent(parent) {
  ...
  std::vector<std::tuple<QString, QString, QString, QString>> vehicleToggles {
    ...
    {"HyundaiRadarTracksToggle", tr("Enable Radar Tracks"), tr("Enable this to attempt to enable radar tracks for Hyundai, Kia, and Genesis models equipped with the supported Mando SCC radar."), ""},
