...
class FrogPilotVariables:
  ...
  def update(self, holiday_theme, started):
    ...
    toggle.hattrick_mode = openpilot_longitudinal and toggle.car_make == "hyundai" and params.get_bool("HatTrick") if tuning_level >= level["HatTrick"] else default.get_bool("HatTrick")
    ...
    toggle.hyundai_radar_tracks = toggle.car_make == "hyundai" and params.get_bool("HyundaiRadarTracks") if tuning_level >= level["HyundaiRadarTracks"] else default.get_bool("HyundaiRadarTracks")
